...
type OpenShiftFeatureGates struct {
	...
	// DistributorServingCertsService enables OpenShift service-ca annotations on the Distributor service
	// to use the in-platform CA and generate a TLS cert/key pair per service for in-cluster data-in-transit encryption.
	// to use this, you need to enable TLS on the distributor and leave caName and certName empty. If you specify caName
	// and certName, those will be used instead of the ones generated by OpenShift.
