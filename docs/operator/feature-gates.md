...
<p>OauthProxy defines the oauth proxy image used to protect the jaegerUI on single tenant.</p>
...
<code>oAuthProxyEnabled</code><br/>
...
<p>OAuthProxyEnabled is used internally for enable by default the oauth proxy for the UI in single tenant mode</p>
