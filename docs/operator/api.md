...
<a href="#tempo-grafana-com-v1alpha1-MonolithicIngestionTLSSpec">
...
<p>MonolithicIngestionTLSSpec defines the TLS settings for ingestion.</p>
...
<p>Enabled defines if TLS is enabled for ingestion</p>
...
<p>CA defines the name of a secret containing the CA certificate</p>
...
<p>Cert defines the name of a secret containing the TLS certificate and private key</p>
